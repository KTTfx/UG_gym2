...
<details>
  ...
  2. **Student Account (With Active Subscription)**
     ```
     University ID: student123
     Password: password123
     ```

  3. **Staff Account (Pending Subscription)**
     ```
     University ID: staff456
     Password: password123
     ```

  4. **Public User Account**
     ```
     Email: john.public@gmail.com
     Password: password123
     ```

  5. **Student with Medical Condition**
     ```
     University ID: student789
     Password: password123
     ```
</details>
